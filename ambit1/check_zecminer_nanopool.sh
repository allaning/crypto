...
# */5 * * * * /home/allan/git/allaning/crypto/ambit1/check_zecminer_nanopool.sh >/dev/null 2>&1
...
LOG=/home/allan/`date +%Y%m%d_%H%M%S`_check_zecminer_nanopool.log
...
if (($RESTART_MINER == 1)); then
  ...
  # Restart miner
  cd /home/allan/
  screen -dmS zecm ./start_zecminer_nanopool.bash
fi
